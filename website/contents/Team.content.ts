    ...
    members: [
      {
        ...
        description: t({
          en: 'As the founder of Logical Spirituality, he guides individuals and communities toward a deeper understanding of nature. Through his well-intentioned courageous actions, the lessons he learned emphasize the wholeness of all living beings and importance of aligning our actions with natural order.\n\nHe is a protean [Spirit Guide](){data-tooltip-id="tooltip" data-tooltip-content="A new and mystical title that embodies the awareness of all living beings guiding one another through visible and invisible bonds. When every human becomes aware of their bonds with each other, this title won’t be needed anymore because it will be the definition of what we call human today."} with engineering, feeling and artistic skills. He is still upset for being the best human on this entire planet.',
          tr: 'Mantıksal Maneviyat\'ın kurucusu olarak bireyleri ve toplulukları doğanın ilkelerine dair daha derin bir anlayışa yönlendirmektedir. İyi niyetle ve cesurca aldığı eylemleri sayesinde deneyimlediği öğretileri, tüm canlıların birbirlerine bağlılığını ve eylemlerimizin doğal düzenle uyumlu olmasının önemini vurgulamaktadır.\n\nMühendislik, sezgi ve sanatsal becerileri olan çok yönlü bir [Maneviyat Rehberi](){data-tooltip-id="tooltip" data-tooltip-content="Görünür ve görünmez bağlarla tüm canlıların birbirlerine rehberlik etmesinin farkında olan yeni ve mistik bir ünvan. Her insanın birbirleriyle olan bağların farkına varmasıyla, Maneviyat Rehberi ünvanına ihtiyaç duyulmayacak çünkü bugünkü insan kavramını yeniden tanımlamış olacak."}\'dir. Bu koskoca gezegendeki en iyi insan olduğu için hâlâ üzgün.',
        }),
        birthday: {
          year: 1988,
          month: 9,
