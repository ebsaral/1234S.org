...
const pageContent = {
  ...
  content: {
    statement: t({
      ...
      fr: "En présence de la justice de la nature, revendiquer vos droits à l’égalité et à la liberté ne peut jamais être remis en question. L’égalité existe parce qu’aucun être n’échappe aux conséquences. La liberté existe parce que chaque être choisit sa propre voie en leur sein."
    })
  },
