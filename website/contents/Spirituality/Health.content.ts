...
const pageContent = {
  ...
  content: {
    ...
    paragraph3: t({
      en: "Within the principle of Interconnectedness in nature, we represent individuals and structures spread over different bodies. The members of a family represent the reflection of a single spirit in different bodies. The smallest and largest building blocks of communities exhibit similar workings in accordance with the principle of Justice in Nature. For example, in the structural integrity of a sports team, the actions of the smaller building blocks that make up that integrity are reflected in the team's success (spirit). We can better see the *silent* language of nature by deciphering the connections between these building blocks. We can read in the connections in nature how even the choices we make in our simple individual lives are reflected in the spirit of the entire society. We can discover that we share a deep connection even with people with whom we have no direct biological relation.",
