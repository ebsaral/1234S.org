...
const pageContent = {
  ...
  content: {
    ...
    reading: t({
      en: md(
        'To better understand how the justice in nature is reflected in [our health](){data-tooltip-id="tooltip" data-tooltip-content="Mental and physical health; luck and talents; environmental health."}, please read our article titled **[How to play in nature?](/en/blog/how-to-play-in-nature)**.',
      ),
      tr: md(
        'Doğadaki adaletin [sağlığımıza](){data-tooltip-id="tooltip" data-tooltip-content="Zihinsel ve fiziksel sağlık; şans ve yetenekler; çevre sağlığı."} nasıl yansıdığını daha iyi anlayabilmek için, **[Doğada nasıl oynamalıyız?](/tr/blog/dogada-nasil-oynamaliyiz)** başlıklı yazımızı okuyunuz.',
      ),
    }),
  },
