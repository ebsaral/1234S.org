...
const pageContent = {
  ...
  content: {
    ...
    items: [
      {
        title: t({
          en: md('Why did we come to the world?'),
          tr: md('Dünyaya neden geldik?'),
        }),
        subtitle: t({
          en: md(
      ...
      {
        title: t({
          en: md('Is life nothing more than a test?'),
          tr: md('Yaşam bir sınavdan ibaret mi?'),
        }),
        subtitle: t({
          en: md(
      ...
      {
        title: t({
          en: md('Is there free will? Is there freedom?'),
          tr: md('Özgür irade var mı? Özgürlük var mı?'),
        }),
        subtitle: t({
          en: md(
      ...
      {
        title: t({
          en: md('What do concepts like angels, devils, and the like represent in nature?'),
          tr: md('Melek, şeytan, vb. kavramlar doğada neyi temsil ediyor?'),
        }),
        subtitle: t({
          en: md(
      ...
      {
        title: t({
          en: md('What do prophets, great commanders, great thinkers, and the like represent in nature?'),
          tr: md('Peygamberler, büyük komutanlar, büyük düşünürler vb. doğada neyi temsil ediyor?'),
        }),
        subtitle: t({
          en: md(
      ...
      {
        title: t({
          en: md('What do jinn, unseen beings, speaking with the dead, and similar things represent in nature?'),
          tr: md('Cinler, görülmeyen varlıklar, ölülerle konuşmak vb. doğada neyi temsil ediyor?'),
        }),
        subtitle: t({
          en: md(
      ...
      {
        title: t({
          en: md('What do tarot cards, fortune-telling, and the like represent in nature?'),
          tr: md('Tarot kartları, fal bakımı vb. doğada neyi temsil ediyor?'),
        }),
        subtitle: t({
          en: md(
      ...
      {
        title: t({
          en: md('Where might we be going?'),
          tr: md('Nereye gidiyor olabiliriz?'),
        }),
        subtitle: t({
          en: md(
