    ...
    items: [
      {
        ...
        subtitle: t({
          en: 'No living being has ever learned the answer to this question. We continue to wonder how we came to be. Because we can understand how The God manifests itself in nature through the teachings of Logical Spirituality, according to the most current information we have, we came to this world to live. By placing life at the center, we continue to gain meaning at the points where our own (self/soul) journeys intersect. What happens after death is not a question we can answer, because we experience rewards and punishments within the framework of natural justice. Within the universe, which transforms independently of space and time, the reality of death appears as a living phenomenon from our personal perspective.',
          tr: 'Bu sorunun cevabını hiçbir canlı şimdiye kadar öğrenemedi. Nasıl geldiğimizi düşünmeye devam ediyoruz. Mantıksal Maneviyat öğretileriyle Tanrı’nın doğada nasıl varlık gösterdiğini anlayabildiğimiz için, elimizdeki en güncel bilgiye göre dünyaya yaşamak için geldik. Yaşamı merkezimize alarak kendi (kişisel/ruhsal) serüvenlerimizin kesiştiği noktalarda anlamlar kazanmaya devam ediyoruz. Öldükten sonra ne olacağı bizim cevap bulabileceğimiz bir soru değil, çünkü doğadaki adalet çerçevesinde ödülleri ve cezaları hissettiğimiz gerçekte deneyimliyoruz. Mekandan ve zamandan bağımsız dönüşüm gösteren evrenin içinde ölüm gerçeği, kişisel bakış açımızda yaşayan bir olgu olarak gözüküyor.',
        }),
      },
      {
        title: t({
        ...
        subtitle: t({
          en: 'Since we ourselves create the general stresses and troubles in life, we can again find the answer within ourselves. Every negative thought and form of behavior directed against the sanctity of life is doomed to disappear in the justice of nature. Around this fundamental truth, it can be seen that no negatively (harmfully) perceived trial in our lives carries any lasting meaning. When we review and restructure the responsibilities we undertake in harmony with nature, we stop seeing life as a test.',
          tr: 'Yaşamdaki genel stresleri ve sıkıntıları bizler yarattığımız için cevabını yine kendimizde bulabiliriz. Yaşamın kutsallığı üzerine getirilen her olumsuz düşünce ve davranış biçimi doğanın adaletinde yok olmaya mahkumdur. Bu temel gerçek etrafında, hayatımızdaki olumsuz (zararlı) anlamdaki hiçbir sınavın kalıcı bir mana taşımadığı görülebilir. Üstlendiğimiz sorumlulukları doğayla uyum içerisinde gözden geçirip yeniden yapılandırdığımızda, yaşamı sınav olarak görmeyiz.',
        }),
      },
      {
        title: t({
        ...
        subtitle: t({
          en: 'An individual’s freedom is determined by the freedom of their surroundings. Since all of our choices are reflections shaped by our environment together with the past, our freedom remains incomplete unless we understand and heal our emotions. In the sight of The God, all the choices we will make are already known. Therefore, life is nothing more than accompanying a shared journey of destiny with our feelings. The consequences of choices we make while ignoring the negativity around us are reflected in our later choices or in future generations. In today’s global system, the fact that [the wealthy are in a position of enslaving our lives](/en/blog/the-rape-case-of-big-tech-companies) is a general result of citizens not taking responsibility and of careless consumption habits. For this reason, diseases and disasters continue to restrict our freedom.',
          tr: "Bireyin özgürlüğü çevresinin özgürlüğü ile belirlenir. Hepimizin seçimleri çevremizin geçmişle birlikte yoğrulan yansımaları olduğu için, hislerimizi anlayarak iyileştirmedikçe özgürlüğümüz eksik kalır. Tanrı'nın nezdinde yapacağımız tüm seçimler önceden bellidir. Bu yüzden, yaşam sadece ortak kader yolculuğuna hislerimizle eşlik etmekten ibarettir. Çevremizdeki olumsuzlukları ihmal ederek yaptığımız seçimlerin cezaları daha sonraki seçimlerimize veya gelecek nesillerimize yansır. Şu anki küresel sistemde [zenginlerin yaşantılarımızı köleleştirmiş pozisyonda olmaları](/tr/blog/buyuk-teknoloji-sirketlerinin-tecavuz-vakasi), vatandaşların sorumluluk almamaları ve umursamaz tüketme alışkanlığının genel bir sonucudur. Bundan dolayı, hastalıklar ve afetler özgürlüğümüzü kısıtlamaya devam ediyor.",
        }),
      },
      {
        title: t({
          en: 'Do sacred (holy) teachings or books have any significance in nature?',
          tr: 'Kutsal öğretilerin veya kitapların doğada bir önemi var mı?',
        }),
        subtitle: t({
          en: 'Every action you take, every sound you make, every sentence you utter, or every word you write, is a reflection of The God in nature. No doctrine that contradicts the Justice in Nature holds value in The God’s perspective. Consequently, no text is sacred. Any action that disrupts the balance of equality and freedom in nature leads to consequences such as disease and natural disasters.',
          tr: 'Herhangi bir hareketiniz, çıkardığınız ses, kurduğunuz bir cümle veya yazdığınız bir yazı, Tanrı’nın doğadaki birer yansımalarıdır. Doğadaki Adalet ile örtüşmeyen hiçbir öğreti Tanrı nazarında değer görmez. Haliyle hiçbir metin kutsal değildir. Doğadaki eşitlik ve özgürlük dengesini bozan her davranış hastalık ve doğal afetler gibi sonuçlara vesile olur.',
        }),
      },
      {
        title: t({
        ...
        subtitle: t({
          en: 'The fundamental reasons for the emergence of mystical characters that are interpreted similarly across different belief systems are the period-specific reflections of the bonds societies established with The God. One of the figures mentioned in mythological narratives, the angel named Azrael, actually represents a human figure. Since there were no civil laws at that time, in societies where much suffering was experienced, certain figures would come to be placed under the special protection of The God. Those who harmed figures (beings) under such high protection would face punishments in nature through The God. The belief that the one who delivered the punishment was the figure called Azrael reflects the perspective of the society of that time in interpreting The God. Even if we do not see it within today’s global system, justice in nature continues to maintain its validity in the same way. Harming a being who is in need of The God’s protection *(see: the expression “an angel-like person”)* may lead to us losing our own lives.',
          tr: "Her farklı inanışta benzer şekilde yorumlanan mistik karakterlerin temel çıkış sebepleri, toplulukların Tanrı ile kurmuş oldukları bağların dönemsel yansımalarıdır. Mitolojik anlatılarda bahsi geçen figürlerden biri olan Azrail isimli melek aslında bir insan figürünü temsil eder. O dönemde medeni kanunlar olmadığı için, çok fazla acının yaşandığı toplumlarda Tanrı’nın özel koruması altına alınan figürler oluşurdu. Yüksek derecede koruma altına alınan figürlere (canlılara) zarar verenler, Tanrı aracılığıyla doğadaki cezalarla karşılaşırlardı. Cezayı verenin Azrail isimli figür olduğunun düşünülmesi ise o dönemde Tanrı’yı yorumlayan toplumun bakış açısıdır. Güncel küresel sistem içerisinde görmüyor olsak bile, doğadaki adalet geçerliliğini aynı şekilde korumaya devam ediyor. Tanrı'nın korumasına muhtaç olan bir canlıya zarar vermemiz *(bkz: 'melek gibi insan' deyimi)*, yaşantımızı kaybetmemize vesile olabilir.",
        }),
      },
      {
        title: t({
        ...
        subtitle: t({
          en: 'All people who have been interpreted as special throughout history had equal opportunities and chances in nature, just like other people. Their rising to prominence over time was due to the divine support needed to heal the harmful actions within the communities they lived in and around. All leaders who failed to use the opportunity given to them well and instead harmed other communities faced the justice of nature like everyone else and experienced the pain they inflicted on other beings. No being receives special treatment. Most people today have more opportunities and abilities than all those who were once seen as special in the past. Anyone who wants to heal any society by taking responsibility can gain similar divine support. The difficulty of the matter you would take responsibility to improve is mostly because of choices made before you or necessary actions being postponed. However, no matter how difficult the matter, nothing is impossible with divine support. You need to have complete faith in The God and never give up. In nature, the definitions of mind or intelligence do not actually hold a special place; each is bestowed as a talent (creativity) to be a divine enhancement. Natural talents are readily accessible in every individual and society where life experience is in harmony with nature. In our blog post [Stories and Myths](/en/blog/stories-and-myths), you can read an example story from Al-Khiḍr.',
          tr: "Tarihte özel olarak yorumlanan tüm insanlar, diğer insanlar gibi doğada eşit fırsatlara ve şanslara sahiplerdi. Zaman içinde onların ön plana çıkmaları, yaşadıkları ve etraflarındaki topluluklar içindeki kötü eylemlerin iyileşmesi için gerekli olan ilahi takviyelerdi. Kendilerine verilen şansı iyi değerlendirmeyerek başka topluluklara zarar veren tüm liderler, herkes gibi doğanın adaletiyle yüzleşerek diğer canlılara verdikleri acıyı yaşadılar. Hiçbir canlı özel muamele görmez. Günümüzdeki insanların çoğunluğu, geçmişte özel olarak görülen tüm insanlardan daha fazla şansa ve yeteneklere sahipler. Sorumluluk alarak herhangi bir toplumu iyileştirmek isteyen herkes benzer ilahi takviyeleri kazanabilir. Sorumluluk alacağınız konunun zorluğu, sizden önce yapılan seçimlerden veya gerçekleştirilmesi gereken eylemlerin ertelenmesinden dolayıdır. Fakat herhangi bir konu ne kadar zor olursa olsun, ilahi takviyeleriniz eşliğinde hiçbir konu imkansız değildir. Tanrı'ya olan inancınızın tam olması ve pes etmemeniz gerekir. Doğada, akıl veya zekâ tanımlarının aslında özel bir yeri yoktur; her biri ilahi takviyeler olarak yetenek (yaratıcılık) şeklinde bahşedilmişlerdir. Yaşam tecrübesinin doğa ile uyumlu olduğu her bireyde ve toplumda doğal yeteneklere kolayca ulaşılabilir. [Hikâyeler ve Mitolojiler](/tr/blog/hikayeler-ve-mitolojiler) isimli yazımızda, Hazreti Hızır hakkındaki örnek bir hikâyeyi okuyabilirsiniz.",
        }),
      },
      {
        title: t({
        ...
        subtitle: t({
          en: 'We need to examine the factors that we interpret as miracles and curses. An event that is a miracle for you may be a curse for someone else. Even today, many similar miracles or curses exist. When the justice of nature is about to take place, the way people who possess divine support (abilities) perceive coincidences and convey them to the public is interpreted as a miracle. In this way, they gain recognition within or around communities. All communities that continue to use miracles (reward) only for themselves and, by moving away from goodness, harm other beings have to face curses (negative consequences, punishments) in nature. The concept of *coincidence* mentioned in the journey of destiny is an incomplete notion that emerged over time due to our inability to resolve cause-and-effect relationships in nature.',
          tr: 'Mucize ve lanet olarak yorumladığımız faktörleri incelememiz gerekir. Sizin için mucize olan bir vaka, başkası için bir lanet olabilir. Bugün de benzer birçok mucize veya lanet mevcuttur. Doğanın adaletinin gerçekleşeceği zamanlarda ilahi takviyelere (yeteneklere) sahip olan insanların tesadüfleri hissederek halka aktarış biçimleri mucize olarak yorumlanır. Böylece topluluklar içinde veya etraflarında bilinirlik kazanırlar. Mucizeleri (ödül) sadece kendileri için kullanmaya devam edip iyilikten uzaklaşarak başka canlılara zarar veren tüm topluluklar, doğadaki lanetlerle (olumsuz sonuçlarla, cezalarla) karşılaşmak zorunda kalırlar. Kader yolculuğunda bahsi geçen *tesadüf* anlayışı, doğadaki neden-sonuç ilişkilerini çözememekten dolayı zaman içinde oluşan eksik bir kavramdır.',
        }),
      },
      {
        title: t({
      ...
      },
      {
        ...
        subtitle: t({
          en: "By placing life, the sacred gift of The God, at the center of our lives, we should strive to understand all living beings through the lens of our shared health. A being in nature can be considered permissible (halal) if it does not harm our health. A being that harms our health can be considered forbidden (haram). An action or substance that harms the health of only one person or society may be beneficial to the health of another. Behaviors defined as forbidden by some leaders in the past may have emerged only as punishments for those leaders' own actions. To enslave or treat any living being as a slave is to oppose life, the sacred gift of The God. Therefore, any text that attempts to explain how to treat a slave (such as law, zakat, sadaqa, etc.) naturally represents associating partners with The God (shirk). All laws or rules that do not advocate equality are interpretations made by the rulers of that era and are not divinely (fairly) ordained. The illnesses or natural disasters that result from a lack of respect for life provide the necessary justice.",
          tr: "Tanrı'nın kutsalı olan yaşamı hayatımızın merkezine alarak ortak sağlığımız üzerinden tüm canlıları anlamaya çalışmalıyız. Doğadaki bir varlık sağlığımıza zarar vermiyorsa helal olarak görülebilir. Sağlığımıza zarar veren bir varlık ise haram olarak görülebilir. Sadece bir kişinin veya toplumun sağlığına zarar veren bir eylem veya madde, başka birinin sağlığına iyi geliyor olabilir. Geçmişte bazı liderler tarafından haram olarak tanımlanan davranışlar, o liderlerin kendi tavırlarından dolayı sadece kendilerine verilen cezalardan açığa çıkmış olabilir. Herhangi bir canlıyı köle yapmamız veya köle görmemiz ise Tanrı'nın kutsalı olan yaşama karşı çıkmaktır. Bu yüzden içinde köleye nasıl davranılması gerektiğini açıklamaya çalışan (kanun, zekat, sadaka, vs.) herhangi bir metin doğal olarak Tanrı'ya şirk koşmayı temsil eder. Eşitliği savunmayan tüm kanunlar veya kurallar o dönemin yöneticileri tarafından konulan ve ilahi (adil) olmayan yorumlamalardır. Yaşama duyulmayan saygının karşılığında vücudumuzda oluşan hastalıklar veya doğal afetler gereken adaleti sağlar.",
        }),
      },
      {
        title: t({
      ...
      },
      {
        ...
        subtitle: t({
          en: 'In light of the current teachings we have reached, it seems easy to build a future in which no living being becomes ill, as our actions are corrected across society. In a social order where no being is sick, we would reach a way of life in which only aging would be seen as an illness (or a negative condition). What later generations who reach that point would need to think about is how they can live longer through natural means, or how they might not die at all. Alongside these realities, we have a hypothetical vision: Within the understanding of the Wholeness in Nature, living beings will be able to easily shape each other/their environment and acquire a timeless mental structure (such as remembering every memory). To bring this hypothetical vision to reality, all of humanity needs to attain divine awareness.',
          tr: 'Ulaştığımız güncel öğretilerin ışığında, eylemlerimizin toplum genelinde düzeltilmesiyle birlikte hiçbir canlının hasta olmayacağı bir gelecek inşa etmemiz kolay gözüküyor. Hiçbir canlının hasta olmadığı bir sosyal düzende, sadece yaşlanmanın hastalık (veya olumsuzluk) olarak görüleceği bir yaşam tarzına kavuşmuş oluruz. O noktaya ulaşan sonraki nesillerin düşünmesi gereken husus ise doğal yollarla nasıl daha uzun ömürlü olabilecekleri veya hiç ölmeyecekleri olur. Bu gerçeklerin yanında hayali bir öngörümüz var: Doğadaki Bütünlük kapsamında canlılar birbirlerini/çevrelerini kolayca şekillendirebilecek ve zamandan bağımsız bir zihinsel yapıya (her hatırayı hatırlamak gibi) kavuşabilecekler. Bu hayali öngörüyü gerçeğe ulaştırmak için tüm insanlık olarak ilahi farkındalığa kavuşulması gerekiyor.',
        }),
      },
    ],
    contact: t({
      en: 'You can [contact us](/contact) to understand Logical Spirituality in depth and find answers to your questions. We continue to improve our teachings after each question or debate.',
      tr: "Mantıksal Maneviyat'ın detaylarını daha iyi anlamak ve sorularınıza cevap bulmak için [bizimle iletişime geçebilirsiniz](/iletisim). Her sorulan soruyla veya tartışmayla birlikte öğretilerimizi geliştirmeye devam ediyoruz.",
    }),
  },
