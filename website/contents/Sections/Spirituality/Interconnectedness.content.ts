...
export default {
  ...
  content: {
    ...
    paragraph1: t({
      en: 'Rather than egocentric approaches, we can gain awareness of the depth of our connection with nature by paying attention to the details of our environment and creations. Because every action reflects the details of the life around it. Every movement, sound, thought, and work of art is interconnected in harmony with the balance of nature.',
    ...
    paragraph3: t({
      en: 'Our emotions, beyond time and space, reflect onto each other in an intertwined manner. Consequently, our life connections are multifaceted. Our senses, which can make invisible connections with each other visible, prove the interconnectedness of life to us in different ways.',
