...
const pageContent = {
  ...
  content: {
    ...
    description: t({
      en: 'We are all trying to live by feeling nature within a tiny part of the infinite universe, which we define as Earth. To better understand the harmony between our mind and body, we need to approach our observations as a small reflection of nature from a broader perspective. **Rather than egocentric approaches, we can gain awareness of the depth of our connection with nature by paying attention to the details of our environment and creations.** Because every action performed also reflects the details of the life around it. Every sound, movement, word, thought, and piece of art is interconnected. So, how can we make this connection visible?',
      tr: 'Hepimiz, sınırsız evrenin içinde küçücük bir alan olan ve Dünya olarak tanımladığımız bir bütünde doğayı hissederek yaşamaya çalışıyoruz. Zihnimizin vücudumuzla olan uyumunu daha iyi kavrayabilmek için, doğanın küçük bir iz düşümü olarak, gözlemlerimizi daha geniş bir bakış açısıyla ele almamız gerekiyor. **Benmerkezci yaklaşımlardan ziyade, çevremizin ve yaratımlarımızın ayrıntılarına dikkat ederek doğayla olan bağımızın derinliğine yönelik farkındalık kazanabiliriz.** Çünkü gerçekleştirilen her eylem aynı zamanda çevresindeki yaşamın detaylarını yansıtır. Her ses, hareket, kelime, düşünce ve sanat eseri birbirine bağlıdır. Peki, bu bağı nasıl görünür kılabiliriz?',
    }),
    experiment: {
      title: t({
        en: 'This sample experiment can help you gain awareness',
        tr: 'Bu örnek deney farkındalık kazanmanıza yardımcı olabilir',
      }),
      description: t({
        en: 'Put on headphones to limit distractions. Use visual recording devices to capture the place you are in and the area you want to observe. Focusing your mind on yourself, start speaking, writing, drawing, or creating music in the room. While you are engaged in your creation, allow other beings to perform the actions they want in your room, home, garden, or street. Continue this experiment for a while. After the process, carefully examine your recorded creations. You may notice the harmony between a word you spoke, a movement you made, a mistake you committed, or a choice you took and other beings. The color choices, movements, speech, and even thoughts of those beings you do not hear or see are reflected in every form of your creation. In this way, you can realize that through your own existence, you also reflect the traces of beings around you.',
