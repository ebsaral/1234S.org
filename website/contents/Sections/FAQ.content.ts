  ...
  content: {
    ...
    items: [
      ...
      },
      {
        ...
        subtitle: t({
          en: 'We need to examine the factors that we interpret as miracles and curses. An event that is a miracle for you may be a curse for someone else. Even today, many similar miracles or curses exist. When the justice of nature is about to take place, the way people who possess divine support (abilities) perceive coincidences and convey them to the public is interpreted as a miracle. In this way, they gain recognition within or around communities. All communities that continue to use miracles only for themselves and, by moving away from goodness, harm other beings have had to face curses in nature. The concept of *coincidence* mentioned in the journey of destiny is an incomplete notion that emerged over time due to our inability to resolve cause-and-effect relationships in nature.',
          tr: 'Mucize ve lanet olarak yorumladığımız faktörleri incelememiz gerekir. Sizin için mucize olan bir vaka, başkası için bir lanet olabilir. Bugün de benzer birçok mucize veya lanet mevcuttur. Doğanın adaletinin gerçekleşeceği zamanlarda ilahi takviyelere (yeteneklere) sahip olan insanların tesadüfleri hissederek halka aktarış biçimleri mucize olarak yorumlanır. Böylece topluluklar içinde veya etraflarında bilinirlik kazanırlar. Mucizeleri sadece kendileri için kullanmaya devam edip iyilikten uzaklaşarak başka canlılara zarar veren tüm topluluklar doğadaki lanetlerle karşılaşmak zorunda kaldılar. Kader yolculuğunda bahsi geçen *tesadüf* anlayışı, doğadaki neden-sonuç ilişkilerini çözememekten dolayı zaman içinde oluşan eksik bir kavramdır.',
        }),
      },
      {
        title: t({
        ...
        subtitle: t({
          en: 'As can be understood through the Principle of Wholeness in our teachings, everyone has a deep connection with nature through the Creator. The transformations, developments, or awakenings in our feelings in response to what happens around us reflect, in a divine way, our manner of interaction with nature. The fact that the journey of destiny is independent of time and space leads to many experiences being repeated in similar cycles. Therefore, the behavior of a person from the past or the future is reflected in our current choices. Every event that we feel but cannot see aims to educate us about our interactions with nature (our environment). The existence and choices of the living beings around us are reflected in the feelings within our bodies. If we can interpret our feelings through our shared life experience, we can easily understand that they aim to offer guidance rather than harm us. Because people in the past interpreted their responsibilities in nature through individual perspectives, they found it more accurate to explain them through figures of invisible beings.',
          tr: 'Öğretilerimizdeki Bütünlük ilkesi ile anlayabileceğimiz üzere, herkesin Yaradan aracılığıyla doğayla olan derin bir bağı vardır. Çevremizdeki yaşananlara yönelik hislerimizdeki dönüşümler, gelişimler veya uyarılışlar doğa ile olan etkileşim biçimimizi ilahi olarak yansıtır. Kader yolculuğunun zamandan ve mekandan bağımsız olması, birçok yaşantının benzer döngülerde tekrarlanıyor olmasına vesile olur. Bu yüzden, geçmişteki veya gelecekteki bir insanın davranış biçimi güncel seçimlerimize yansır. Hissettiğimiz fakat göremediğimiz her vaka bize doğayla (çevremizle) olan etkileşimlerimize yönelik eğitim vermeyi amaçlar. Çevremizdeki canlıların varlıkları ve seçimleri vücudumuzdaki hislere yansırlar. Eğer hislerimizi ortak yaşam tecrübemizle yorumlayabilirsek, bize zarar vermekten ziyade rehberlik sunmaya amaçladıklarını kolaylıkla anlayabiliriz. Geçmişteki insanlar doğadaki sorumluluklarını bireysel bakış açılarıyla yorumladıkları için, görünmez canlı figürleriyle açıklamayı daha doğru buldular.',
        }),
      },
      {
        title: t({
        ...
        subtitle: t({
          en: 'On the journey of destiny, everyone has equal opportunities and chances. Our destiny is also shaped according to our past choices. The results of choices made with good intentions are reflected positively both on the individual and on their environment. Since nothing in nature is random, every choice you make is aligned with the next step. Therefore, any imagined work you create with good intentions or any situation you interpret leads to the outcome you interpret through tarot cards. If you wish, you can create your own fortune at home by drawing many pictures with different meanings; you do not need a special card, a special reading, or a special intermediary. When the people who interpret or have interpretations done are not well-intentioned, negative outcomes are reached. As a return for their good intentions, people with more life experience may have broader and more accurate interpretive abilities.',
          tr: 'Kader yolculuğunda herkes eşit fırsatlara ve şansa sahiptir. Kaderimiz aynı zamanda geçmişteki seçimlerimize göre şekil alır. İyi niyetle yapılan seçimlerin sonucu hem bireye hem çevresine olumlu olarak yansır. Doğada rastgele bir şey olmadığı için, yapacağınız her seçim bir sonraki adım ile uyumlur olur. Bu yüzden, iyi niyetle çizdiğiniz herhangi bir hayal ürünü eser veya yorumladığınız herhangi bir durum, tarot kartlarıyla yorumladığınız sonuca ulaşır. Dilerseniz farklı anlamlarda birçok resim çizerek kendi falınızı siz de evinizde oluşturabilirsiniz; özel bir karta, özel bir fala, özel bir aracıya ihtiyacınız yok. Yorumlama yapan veya yaptıran insanların iyi niyetli olmadıkları durumlarda olumsuz sonuçlara ulaşılır. Yaşam tecrübesi daha fazla olan insanların iyi niyetlerinin karşılığı olarak yorumlama yetenekleri daha kapsamlı ve isabetli olabilir.',
        }),
      },
      {
        title: t({
