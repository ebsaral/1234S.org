...
const pageContent = {
  ...
  content: {
    ...
    description: t({
      ...
      tr: "Bütünlük ortak yaşamımızdaki bağı açıklarken, doğanın kendisi adalet yoluyla bağlarımız arasındaki dengeyi sağlar. **Doğadaki adalet, canlılığın ve canlıların sağlık durumlarında kendini kanıtlar.** Doğanın bahşettiği özgürlükte her varlık eşit muamele görür.\n\nHer varlık farklı his kümelerinden oluşan anlamlar barındırır ve iyi ya da kötü eylemler gerçekleştirmemize vesile olur. Her eylemimiz olumlu veya olumsuz biçimde kendi sonuçlarını beraberinde getirir. Doğa gerçek niyetimizi her zaman bilir ve ona uygun sonucu bize doğru çeker.",
    ...
    equality: {
      ...
      description: t({
        ...
        tr: "Tüm canlılar aynı doğa yasalarına tabidir: doğum, beslenme, hastalık, iyileşme ve ölüm. Hiçbiri sebep-sonuç ilişkisinden kaçamaz.\n\nBir canlının olumlu gelişmesinin kendi ötesinde faydalar sağlaması gibi, birinin hissettiği acı diğer ailelerin, toplulukların ve ekosistemlerin sağlığını da etkiler. Öyleyse eşitlik, yalnızca ahlaki bir duruş değildir: **Biyolojik ve ekolojik bir gerçektir.**",
    ...
    freedom: {
      ...
      description: t({
        ...
        tr: "Her varlık yaşamak, beslemek, zarar vermek, korumak, sömürmek, iş birliği yapmak veya görmezden gelmek için özgürdür. \n\nYıkıcı eylemler ekosisteme ve nihayetinde eylemde bulunana zarar verir. **Özgürlük eşitliğe saygı göstermediğinde doğanın adaleti sınırı belirler.** Gerçek özgürlük, tüm canlıların ortak sağlığına saygı duymayı gerektirir.",
    ...
    negativeConsequences: {
      ...
      nature: t({
        ...
        tr: "Kuraklıklar, seller, kasırgalar ve küresel ısınma...",
      ...
      health: t({
        ...
        tr: "Kalp hastalıkları, depresyon, pandemiler ve genetik bozukluklar...",
      ...
      luck: t({
        ...
        tr: "Sokakta, trafikte, işyerlerinde veya evlerde yaşanan kazalar...",
