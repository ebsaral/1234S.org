...
const pageContent = {
  ...
  content: {
    ...
    equality: {
      ...
      description: t({
        en: "All living beings are subject to the same natural laws in their shared life: birth, growth, illness, recovery, and death.\n\nWithin the scope of wholeness, just as the positive development of a being provides benefits to its surroundings, the pain felt by one affects the health of all around it. Equality is **a biological and ecological truth.**",
        ...
        de: "Alle Lebewesen unterliegen in ihrem gemeinsamen Leben denselben Naturgesetzen: Geburt, Wachstum, Krankheit, Heilung und Tod.\n\nIm Rahmen der Ganzheit gilt: So wie die positive Entwicklung eines Wesens Vorteile für seine Umgebung bringt, wirkt sich der Schmerz, den ein Wesen empfindet, auch auf die Gesundheit aller in seiner Umgebung aus. Gleichheit ist **eine biologische und ökologische Wahrheit.**",
        fr: "Tous les êtres vivants sont soumis aux mêmes lois naturelles dans leur vie commune : naissance, croissance, maladie, guérison et mort.\n\nDans le cadre de la totalité, tout comme le développement positif d'un être profite à son entourage, la douleur ressentie par l'un affecte la santé de tous ceux qui l'entourent. L'égalité est **une vérité biologique et écologique.**"
      }),
    },
    freedom: {
      title: t({
