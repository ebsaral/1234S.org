    ...
    items: [
      {
        ...
        subtitle: t({
          ...
          tr: 'İlaç kullanmadan bütün hastalıkları tedavi etmemiz mümkün. Sağlıklı bir toplumda yaşayabilmek ve tedavilerden sonra olumsuz davranışların tekrarlanmaması için her canlının yaşam koşullarının geliştirilmesi gerekir. Çünkü sağlıklı bir yaşam herkes için temel bir haktır.\n\nHastane ve ilaç sayılarındaki artış, toplumun genel sağlığının kötüleştiğini ve olumsuz davranışların arttığını kanıtlar. Dolayısıyla hastane açmak bir başarı değil, yardım çağrısıdır.',
        }),
      },
      {
        title: t({
        ...
        subtitle: t({
          en: "Teaching everyone in detail about the reality of Justice in Nature is essential for the rights and potential of all living beings. An increase in the quality of our lives in line with the balance of Equality and Freedom in nature, which awaits recognition, will positively impact the entire society.\n\nEveryone can learn how to gain and shape more talents, how to align social interactions better with nature's luck scale, how to improve any business in a more healthy way and how to unlock gifts in nature's offerings.",
          tr: 'Doğadaki Adalet gerçeğini her insana ayrıntılı olarak öğretmek, tüm canlıların hakları ve potansiyelleri için gereklidir. Doğadaki fark edilmeyi bekleyen Eşitlik ve Özgürlük dengesi doğrultusunda yaşam kalitelerimizdeki artış, tüm topluma olumlu yansır.\n\nHerkes daha fazla yetenek edinmeyi ve şekillendirmeyi, sosyal etkileşimleri doğanın şans ölçeğiyle daha iyi uyumlu hale getirmeyi, herhangi bir işi daha sağlıklı bir şekilde nasıl geliştireceğini ve doğanın bahşettiği hediyeleri nasıl ortaya çıkaracağını öğrenmelidir.',
        }),
      },
      {
        title: t({
