...
const SupportLink = ({className,}: {className?: string}) => {
    ...
    <Link
        ...
        className={`flex flex-col items-center justify-center w-auto text-sm font-medium  relative b-1 border-white py-2 px-5 text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-offset-2 rounded-2xl hover:rounded-lg transition-all duration-200 ease-in-out ${className}`}
        prefetch={true}
        >
