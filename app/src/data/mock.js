...
export const mockData = {
  ...
  translations: {
    en: {
      ...
      interconnectednessKeyTakeaway: "Nothing in existence stands alone. Every choice, emotion, and action ripples outward, touching countless others — often in ways we cannot easily feel.",
