...
export const mockData = {
  ...
  translations: {
    en: {
      ...
      naturesJusticeFreedomText: "Each of us is free to choose our path — to be compassionate or destructive, generous or selfish — and nature responds accordingly.",
      naturesJusticePositiveConsequencesTitle: "Positive Consequences",
      naturesJusticeNegativeConsequencesTitle: "Negative Consequences",
      naturesJusticePositiveConsequencesItems: {
      ...
      naturesJusticeNegativeConsequencesItems: {
    ...
    tr: {
      ...
      interconnectednessExample: "Hepimiz çevremizle uyum içinde yaşarken, hareketlerimiz ve yarattıklarımız seçimlerimiz ve eylemlerimizle sürekli olarak şekillenir. **Anne karnındaki bir bebeğin genetik gelişimi (dizilimi) ebeveynlerinin seçimleri ve eylemleri doğrultusunda şekillenir.** Bebeğin fiziksel görünümü ailenin yapısına ve yaşanılan çevredeki ilişkilere benzerlik gösterecek bir şekilde ilerler. Bebeğin fiziksel özellikleri, hem ailenin genetik mirasını hem de yaşanılan çevrenin izlerini taşır. Üstelik bu etki yalnızca insan ilişkileriyle sınırlı değildir; hayvanlarla ve doğayla kurulan bağlar da bebeğin genetik yapısına bir şekilde yansır. Böylece bir bebeğin oluşumu ve gelişiminde, çevredeki herkesin ve her şeyin —doğrudan ya da dolaylı— payı bulunur.",

      naturesJusticeTitle: "Doğadaki Adalet: Görünmeyen Mantık",
      naturesJusticeDescription: "Bütünlük ilkesi yaşamın ağını tanımlarken, adalet onu bir arada tutan mantıktır. Doğal adalet içinde her varlık eşit muamele görür ve her varlık özgürce hareket edebilir — ancak **her eylem kendi sonuçlarını taşır**.\n\nDoğadaki her bir varlık, sizin iyi ya da kötü bir eylem gerçekleştirmenize vesile olan anlamlar barındırır. Başkaları eylemlerinizi farklı şekilde yorumlayabilir, ancak doğa sizin gerçek niyetinizi bilir ve ona uygun sonucu size doğru çeker.\n\nDetaylarının içinde, her olumsuz sonuç doğadaki sessiz bir çığlığı anlatır. Detayları kavrayabilmek ise yaşam tecrübesi gerektirir.",
      ...
      naturesJusticeFreedomText: "Hepimiz yolumuzu seçmekte özgürüz — şefkatli veya yıkıcı, cömert veya bencil — ve doğa buna göre karşılık verir.",
      naturesJusticePositiveConsequencesTitle: "Olumlu Sonuçlar",
      naturesJusticeNegativeConsequencesTitle: "Olumsuz Sonuçlar",
      naturesJusticePositiveConsequencesItems: {
