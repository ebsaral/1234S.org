...
export const mockData = {
  ...
  translations: {
    en: {
      ...
      hero: {
        ...
        subtitle: "Expanding Spirituality with Logic in Nature",
        description: "What if the universe is not random at all? What if every illness, every stroke of luck, every success and failure, even every disaster, follows a deeper pattern?",
      ...
      // Sections
      intro: {
        paragraph1: "Spirituality has long pointed us toward two universal truths: **Equality** and **Freedom**. Beyond the distinctions inscribed in human consciousness over the course of shared history, every being partakes in a common essence that surpasses the constructed divisions of culture, race, class, gender, age, and belief. Each life is sacred, carrying intrinsic worth. And alongside this equality is freedom: not just political or economic liberty, but **the deeper liberation from fear, ignorance, and attachment**.",
        ...
        paragraph3: "A deeper question arises:\n*How are equality and freedom maintained in reality?*\nHow is balance ensured when natural truths are disrupted?",
        paragraph4: "**Logical Spirituality** builds on traditional spirituality by uncovering the **unseen logic in nature**. It demonstrates how these truths unfold in practice through two guiding principles: **Interconnectedness** and **Justice in Nature**. Their relationship is explored through a *multidimensional* cycle of learning, with the **health of all living beings** serving as the foundation."
      },
      
      interconnectedness: {
        title: "Interconnectedness:\nA Unified Being",
        quote: "Interconnectedness reveals that our choices are all connected to each other both visibly and invisibly. As natural beings living in a greater existence, our choices shape not only our own destiny but the well-being of the entire system we share together.",
        description: "We all live on Earth, a tiny realm within the boundless universe. Every being is part of a living whole that is called nature. When one living being suffers, the effects rarely stop with them; families, communities, and ecosystems are drawn into the wave. When one living being thrives, the benefits ripple outward too. Interconnectedness means our lives are not private possessions but shared currents in a greater flow.\n\nTo sense your connection with the world around you, focus both on your environment and on what you create. Every expression (output) — whether writing, painting, music, ideas, decision, speech, health condition, or movement — is shaped (inspired) by beings around you. By observing your own creations closely, you can become aware of how deeply you are in sync with your environment.",
        experiment: {
          title: "You can try this example experiment",
          description: "Cover your ears to block out distractions and focus on your creation, then begin creating —writing, painting, or making music— within a room. Record your process, capturing your computer screen, your environment, or both. While you focus on your creation (output), let other people or animals move freely through the space (your room, house, and even garden), without restrictions. After an hour, review the recordings and your creations carefully. You will notice how the presence of others —their movements, conversations, choices, memories, and even subtle thoughts— has left traces within your creation, quietly but visibly shaping the outcome of your creative expressions."
        },
        paragraph1: "*Most of lives begin in a womb...* Our thoughts, movements and creations are continuously shaped by our choices and action, because we all live in harmony within our environment. Similar to the example above, **the genetic development (sequence) of a baby in the womb is mostly shaped by the actions thus consequences of the parents.** The baby's genetic makeup is shaped in a way that reflects the family's genetic heritage and the relationships within the surrounding environment. Moreover, this influence is not limited to human relationships alone; the relations formed with animals and nature also leave their mark on the baby's genetic makeup. Thus, in the formation and development of a baby, everyone and everything in the environment —directly or indirectly— plays a role."
      },

      justiceInNature: {
        title: "Justice in Nature:\nThe Unseen Logic",
        description: "While interconnectedness principle describes the web of life, **justice is the logic that holds it together**. Every being is treated equally within the natural justice, and every being is free to act — but **every action carries its own consequences**.\n\nEach being in nature brings a means for you to carry out either a good or a bad action. While others may interpret your actions differently, nature knows your true intention and draws the fitting consequence toward you. In its details, every negative consequence tells a silent scream in nature. Grasping the details, however, requires life experience.",
        positiveConsequences: {
          title: "Positive Consequences",
          nature: "Fertile soil, balanced weather, and ecological harmony emerge when environments are respected.",
          health: "Strong immunity, recovery from disease, and long life result from alignment with care and balance.",
          luck: "Meeting supportive people, discovering opportunities, or receiving natural protection often follow from bravery, compassion, empathy and caring.",
        },
        negativeConsequences: {
          title: "Negative Consequences",
          nature: "Droughts, floods, hurricanes, and global warming emerge from exploitation and imbalance.",
      ...
      health: {
        title: "Health: The Body as a Mirror of Nature's Justice",
        quote: "Our physical and mental health directly reflects alignment with nature's justice and the quality of our relationships:\n**EVERY DISEASE** is caused by (y)our actions.",
        description: "Positive actions — compassion, honesty, forgiveness, and support for others — strengthen our organs, mental resilience, and overall well-being.\nNegative or harmful actions disrupt balance, weaken the body, and manifest as illness or stress.\n\nActions can be both inward and outward in any relationship. **Your relationship with yourself is equally important as your relationships with others.**",
        analogy: {
          ...
          description: "Body organs function much like individuals’ roles within a society or environment: each organ's biological role (purpose) presents a silent reflection of the choices we make in nature.",
          items: [
        ...
        paragraph1: "Every human body begins life as a complex system, carrying the experiences, choices, and imprints of both the individual and their ancestors. Your body is the whole system, with each organ serving as a vital subsystem.\n\n**When a virus, germ or chemical enters a body, the path it follows is shaped by the decisions and actions you make**. Illness is not random — it can be understood as a warning or a consequence given by nature. If you ignore this signal and continue acting in ways harmful to yourself and/or your environment, the illness may spread deeper into your system, reflecting the direction of your choices to your body. When you begin to understand your own system (your life and environment) and align your actions with healing, responsibility, and renewal, the illness gradually finds its way out. Positive change fosters balance and recovery from within.\n\nSimilarly, **The Organ-Action-Result Analogy also applies to accidents.** Any damage your body sustains as a result of an accident is intended to teach you a lesson, reflecting the actions you took before the incident. The way an accident occurred explains your action that caused it. \n\nRemember, nature always offers the opportunity to make amends for your mistakes, though some errors may lead to irreversible losses. **Your personal opinion may not always align with justice in nature.**",
        examples: [
          "If you had a heart attack before, probably you caused a lot of struggle (blocks) in some living being's life.",
          "If your eyes can't see properly, probably you ignored/blocked someone's path .",
          "If your ears lost their hearing, probably you ignored somebody's voice or cry for help. Or, you blocked someone's freedom to hear.",
          "If you had a form of cancer, probably you caused a living's death or you tortured them."
        ]
      },

      examples: {
        title: "Examples for Logical Spirituality",
        description: "To understand nature's language, you may lean on human symbols —letters, words, numbers, and songs— as keys. Listen carefully, and you'll find that nature is constantly doing in subtle detailed harmony, revealing the world's invisible rhythms.\n\n*When you hear a family recount a fatal car accident on the news, you may, in fact, be hearing a quiet confession of an unseen crime.*",
        items: [
          ...
          {title: "Talents", subtitle: "A person's talent flourishes when it is nurtured by parents, teachers, mentors, and the community. Some talents arise naturally, shaped by the needs of the person's environment and the purpose they are meant to serve.\n\nA beautiful voice may arise as a gift, reflecting the opportunities you or your ancestors gave to the beings around you. Remember that you owe all your talents to the positive and/or negative relationships you have with your environment."},
          {title: "Luck (Opportunities)", subtitle: "All living beings naturally have a right to access a clear path to infinite luck (opportunities). The choices and actions of every living being shape the ease and opportunities available to future generations.\n\nEven with a high level of risk, the likelihood of you having an accident can still be very low.\n\nIf your environment keeps blocking your opportunities continuously, nature's justice may clear your path in time."}
        ]
      },

      endingStatement: "In the presence of nature's justice, claiming your rights to equality and freedom can never be questioned.",
    ...
    tr: {
      ...
      hero: {
        ...
        subtitle: "Doğadaki Mantıkla Maneviyatı Derinleştirmek",
        description: "Ya evrendeki hiçbir şey rastgele değilse? Her hastalık, her şans eseri olay, her başarı ve başarısızlık, hatta her felaket, daha derin bir düzeni mi takip ediyor?",
      ...
      intro: {
        ...
        paragraph3: "Fakat daha derin bir soru ortaya çıkıyor:\n*Eşitlik ve özgürlük gerçekte nasıl korunuyor?*\nDoğal gerçeklerde dengesizlik olduğunda denge nasıl sağlanır?",
      ...
      health:{
        title: "Sağlık: Doğadaki Adaletin Aynası Olarak Vücut",
        quote: "Fiziksel ve zihinsel sağlığımız, doğanın adaletiyle ve ilişkilerimizin niteliğiyle olan uyumumuzu doğrudan yansıtır:\n**HER HASTALIK** eylemlerimizden kaynaklanır.",
        description: "Olumlu eylemler — şefkat, dürüstlük, affedicilik ve başkalarını desteklemek — organlarımızı, zihinsel dayanıklılığımızı ve genel sağlığımızı güçlendirir.\nOlumsuz veya zararlı eylemler dengeyi bozar, bedeni zayıflatır ve hastalık veya stres olarak ortaya çıkar.\n\nEylemler hem içe hem dışa dönük olabilir. **Kendinizle olan ilişkiniz, başkalarıyla olan ilişkileriniz kadar önemlidir.**",
        analogy: {
          ...
          description: "Vücut organları, bir toplum veya çevredeki bireylerin rollerine çok benzer şekilde işlev görür: Her organın biyolojik rolü (amacı), doğada yaptığımız seçimlerin sessiz bir yansımasını sunar.",
          items: [
      ...
      examples: {
        title: "Mantıksal Maneviyata Dair Örnekler",
        description: "Doğanın dilini anlamak için insanlar tarafından kullanılan sembollere —harfler, kelimeler, sayılar ve şarkılar— başvurabilirsiniz. Dikkatlice dinleyin, doğanın sürekli ince bir uyum içinde hareket ettiğini ve dünyanın görünmeyen ritimlerini ortaya çıkardığını göreceksiniz.\n\nHaberlerde bir ailenin ölümcül bir trafik kazasını anlattığını duyduğunuzda, aslında görünmeyen bir suçun sessiz itirafını da duymuş olabilirsiniz.",
        items: [
          ...
          {title: "Yetenekler", subtitle: "Bir kişinin yeteneği, ebeveynleri, öğretmenleri, rehberleri ve toplum tarafından desteklendiğinde gelişir. Bazı yetenekler doğal olarak ortaya çıkar, kişinin çevresinin ihtiyaçları ve hizmet etmesi gereken amaç tarafından şekillendirilir.\n\nGüzel bir ses, sizin veya atalarınızın etrafınızdaki varlıklara verdiği fırsatların bir yansıması olarak bir hediye olabilir. Unutmayın ki, tüm yeteneklerinizi çevrenizle olan pozitif ve/veya negatif ilişkilere borçlusunuz."},
          {title: "Şans (Fırsatlar)", subtitle: "Tüm canlıların doğal olarak sınırsız şansa (fırsatlara) erişme hakkı vardır. Her canlının seçimleri ve eylemleri, gelecekteki nesillere sunulan kolaylık ve fırsatları şekillendirir.\n\nYüksek bir risk seviyesine rağmen, kaza geçirmeniz olasılığı çok düşük olabilir.\n\nEğer çevreniz sürekli olarak fırsatlarınızı engelliyorsa, doğanın adaleti zamanla yolunuzu açar."}
        ]
      },

      endingStatement: "Doğadaki adaletin huzurunda, eşitlik ve özgürlük için haklarınızı talep etmeniz asla sorgulanamaz.",
  ...
  // Images
  images: {
    hero: "https://images.unsplash.com/photo-1705131840184-2ebed7ccf9d5",
    interconnectedness: "https://images.unsplash.com/photo-1513836279014-a89f7a76ae86",
    naturesJustice: "https://images.unsplash.com/photo-1705051738789-02ff513c9beb",
