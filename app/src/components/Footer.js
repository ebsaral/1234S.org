...
import { Heart, Globe, Leaf, Facebook, Twitter, Instagram, Youtube, Linkedin } from 'lucide-react';
        ...
        <div className="text-center">
          ...
          <div className="pt-8 border-t border-gray-700">
            ...
            <div className="flex justify-center items-center gap-8 mt-8">
              <div className="flex items-center justify-center w-12 h-12 rounded-full bg-emerald-600/20 backdrop-blur-sm">
                <Heart className="text-emerald-400" size={24} />
              </div>
              <div className="flex items-center justify-center w-12 h-12 rounded-full bg-blue-600/20 backdrop-blur-sm">
